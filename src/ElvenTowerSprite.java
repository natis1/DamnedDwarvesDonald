...
public class ElvenTowerSprite extends ElvenSprite {
    ...
    public void ShootBullet(int xTarget, int yTarget, int enemyIndex) {

        bullets.add(new ElvenMissile(x + getWidth() / 2, y + getHeight() / 2, angle, "main/resources/faearrow.png", xTarget, yTarget, enemyIndex));
